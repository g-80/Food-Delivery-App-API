...
public class QuoteTokenServiceTests
{
    ...
    {
        // Arrange
        var payload = new QuoteTokenPayload { UserId = 123, Items = new List<ItemRequest> { new() { ItemId = 33, Quantity = 2 }, new() { ItemId = 44, Quantity = 1 } }, TotalPrice = 840, ExpiresAt = DateTime.UtcNow };
